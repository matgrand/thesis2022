...
\usepackage{graphicx,subcaption,siunitx,multirow,multicol,hyperref,geometry,amsmath,amssymb,tikz,circuitikz,gensymb,bigfoot,filecontents,listing}
...
\subsection{Vehicle model and characterization of the heading error}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{imgs/bicycle_model.jpg}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{imgs/heading_error.jpg}
...
\subsection{Real track and simulation environment}
    ...
    \begin{figure}
        \begin{subfigure}[c]{\textwidth}
            \centering
            \makebox[\textwidth][c]{\includegraphics[width=1.1\linewidth]{imgs/bfmc_track.png}}
        \end{subfigure}
        \begin{subfigure}[c]{\textwidth}
            \centering
...
\subsubsection*{Heading error calculation}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.6\linewidth]{imgs/he_calc.jpg}
...
% https://boschfuturemobility.com/documentation/connectiondiagram.html
    ...
    \begin{figure}
        ...
        \begin{subfigure}[c]{\textwidth}
            \centering
            \includegraphics[width=\textwidth]{imgs/vehicle_assembly2.png}
        \end{subfigure}
        \begin{subfigure}[c]{\textwidth}
            \centering
...
\begin{figure}
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=0.9\linewidth]{figures/turns.eps}}
