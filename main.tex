...
\section{Optimal path}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=\linewidth]{full_path.png}
...
\subsection{Data Collecting}
    Discussione su tecniche e metodi di raccolta dei dati per il training nel
    simulatore, possibili varianti, tipi di hyperparamters...
...
\subsection{Training}
Discussione sulla baseline usata nella BFMC, dettagli dell'architettura, dei
vari processi, analisi degli hyperparamters
